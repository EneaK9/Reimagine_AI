...
class ApiConfig {
  ...
  // Room Upgrade Endpoints
  static const String roomUpgradeAnalyze =
      '$apiVersion/room-upgrade/analyze/upload';
  static const String roomUpgradeSearch =
      '$apiVersion/room-upgrade/search-products';
  static const String roomUpgradeGenerate = '$apiVersion/room-upgrade/generate';
  ...
  static String roomGenerateTexture(String id) =>
      '$apiVersion/rooms/$id/generate-texture';

  // Depth/3D Mesh Endpoints (Photo-based)
  static const String depthGenerateMesh = '$apiVersion/depth/generate-mesh';
  static const String depthGenerateMeshUpload =
      '$apiVersion/depth/generate-mesh/upload';
  ...
  static String depthMeshInfo(String meshId) =>
      '$apiVersion/depth/mesh/$meshId/info';
  ...
  static const Duration longReceiveTimeout = Duration(
    minutes: 10,
  ); // Heavy operations (mesh, AI)
}
